...
public class IOStatusManager : MonoBehaviour {
    ...
    public Text FlagCalibrationText;
    public Text FlagServoOnText;
    public Text FlagEmergentStopText;
    public Text FlagFaultText;
    public Text FlagTaskInProcessText;
    public Text FlagRobotMovingText;
	...
	void Update ()
    {
		...
		ValueADC1.text = DynaLinkHS.StatusSensor.ADCSensor1.CalculateValue.ToString();
		ValueADC2.text = DynaLinkHS.StatusSensor.ADCSensor2.CalculateValue.ToString();

        //ValueDiagBatt.text = DynaLinkHS.StatusADC.RealVolt.ToString();

        //CurrentMechType.text = DynaLinkHS.MechanismType.ToString();

        FlagCalibrationText.text = DynaLinkHS.StatusFlag.FlagCalibration.ToString();
        FlagServoOnText.text = DynaLinkHS.StatusFlag.FlagServoOn.ToString();
        FlagEmergentStopText.text = DynaLinkHS.StatusFlag.FlagEmergentStop.ToString();
        FlagFaultText.text = DynaLinkHS.StatusFlag.FlagFault.ToString();
        FlagTaskInProcessText.text = DynaLinkHS.StatusFlag.FlagTaskInProcess.ToString();
        FlagRobotMovingText.text = DynaLinkHS.StatusFlag.FlagRobotMoving.ToString();
    }

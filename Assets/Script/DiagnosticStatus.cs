...
public class DiagnosticStatus : MonoBehaviour {
    ...
    public float test_RedundantX;
    public float test_RedundantY;
    ...
    public int _tPcbaEthCheckData;

    public float _tLowPassPosJ1;
    public float _tLowPassPosJ2;
    public float _tLowPassTorJ1;
    public float _tLowPassTorJ2;
    ...
    void MotDiagStatus()
    {
        ...
        _tLowPassPosJ1 = DynaLinkHS.StatusRobot.PositionDataJoint1;
        _tLowPassPosJ2 = DynaLinkHS.StatusRobot.PositionDataJoint2;
        _tLowPassTorJ1 = DynaLinkHS.StatusRobot.KineticDataJoint1;
        _tLowPassTorJ2 = DynaLinkHS.StatusRobot.KineticDataJoint2;
        ...
        //SysStatus.MasVersion = DynaLinkHS.SoftwareVersion.ToString();
        _tMasVersion = SysStatus.MasVersion;

        //SysStatus.DTCCodeVal = DynaLinkHS.DTCCode;
        _tDTCDisp = SysStatus.DTCCodeVal;

        test_RedundantX = DynaLinkHS.StatusRobot.KineticDataJoint1;
        test_RedundantY = DynaLinkHS.StatusRobot.KineticDataJoint2;

        //_tPcbaEthCheckData = DynaLinkHS.PcbaEthCheckData;
    }

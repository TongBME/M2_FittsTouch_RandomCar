...
{
    enum FFTAICommunicationV2X2RobotInterfaceOperationMode
    {
        // flag
        ...
        FootPressureInstalled = 0x0A011302,
        FootPressureAccessible = 0x0A011303,
        FootPressureCalibrate = 0x0A011304,
